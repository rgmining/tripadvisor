...
project = u'Trip Advisor Dataset Loader'
...
# To add GitHub link.
rst_prolog = """
:github_url: https://github.com/rgmining/tripadvisor
"""
...
html_context = {
    "base_url": "https://rgmining.github.io/tripadvisor/",
    "twitter": "@junkawamoto",
...
htmlhelp_basename = 'TripAdvisorDatasetdoc'
...
latex_documents = [
    (master_doc, 'tripadvisorDataset.tex', u'Trip Advisor Dataset Documentation',
...
man_pages = [
    (master_doc, 'tripadvisordataset', u'Trip Advisor Dataset Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TripAdvisorDataset', u'Trip Advisor Dataset Documentation',
     author, 'TripAdvisorDataset', 'One line description of project.',
     'Miscellaneous'),
]
